...
Vue.component('CoinDetail', {
    ...
    mounted() {
        // Aquí ya tengo disponible en DOM y puedo acceder a sus elementos, en el created no podría
    ...
    <div>
        ...
        <!-- Cuando tenemos varios slots debemos ponerlees nombres -->
...
new Vue({
    ...
    // De esta forma podemos atacharnos al ciclo de vida de Vue mediante hooks, este y otros hooks están en su documentación
    created() {
        // El created es bueno para tener información de una API REST, es uno de los primeros eventos que ocurren en el ciclo de vida del componente
        console.log("created");
    },
